...
var wordBank = ["ancient", "alien", "carnac", "pyramid", "stonehenge", 
"teothiuacan", "easterisland", "sacasayhuaman", "vimanas", "sumerian", "sarcophagus",
 "mahabharata", "ramyana", "pumapunku", "baalbek", "chairo", "giza", "derinkuyu", 
 "cusco", "machupicchu", "nazca", "roswell", "area51", "delphi", 
 "corinth", "epidarus", "knossos", "mycenae", "gobeklitepe", 
 "stargate", "tiahuanaco", "abydos", "extraterrestrial", 
 "monoliths", "anunnaki", "reptillians", "millenarianism", "nibiru", "atlantis", 
 "dogu", "yonaguni", "resounding", "visited", "stoneage", "archaeologist", "megalith", 
 "hyperborea", "speculation", "coincidence", "pythagorean", "geometric", "space", "astronaut", "energy", "apollo", 
 "Prometheus", "zeus", "thor", "mothership", "greys", "advancement", "artifact"
]
...
function winLose() {
    ...
    if (rightGuessCounter === numBlanks) {
        ...
        //Changes HTML
        document.getElementById('winCounter').innerHTML = winCount;
        alert('Did you just win? Ancient Alien theorists believe the answer is a resounding yes!');
        reset();
    }
    ...
    // When number of Guesses reaches 0 then You lose
        ...
        //Changes HTML
        document.getElementById('lossCounter').innerHTML = loseCount;
        alert('That is incorrect...but what if it were true?');
        reset();
    }
}
